    ...
    <div style={{ padding: '2rem', maxWidth: '1200px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          ...
          <p style={{ color: '#666', fontSize: '0.875rem' }}>{projects.length} {projects.length === 1 ? 'project' : 'projects'}</p>
        </div>
        <a href="/app" style={{
      ...
      {projects.length === 0 ? (
        <div style={{ 
          ...
          <p style={{ color: '#666', marginBottom: '1.5rem', fontSize: '0.875rem' }}>Generate a website and save it to see it here</p>
          <a href="/app" style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '1.25rem' }}>
          {projects.map((project) => (
            ...
            >
              <div 
                style={{ height: '180px', background: '#1a1a1a', position: 'relative', cursor: 'pointer' }}
              ...
              <div style={{ padding: '1rem', cursor: 'pointer' }} onClick={() => openProject(project)}>
